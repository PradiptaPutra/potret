...
fn store_and_open_popup(
    ...
    let win_w = 230.0_f64;
    // Image fills full width; height clamped to [100, 150] matching the frontend formula
    let img_h = (win_w * h as f64 / w as f64).min(150.0).max(100.0);
