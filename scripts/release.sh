...
echo "  Local:    ./scripts/install-local.sh   (installs to /Applications the right way —"
echo "            never raw cp: it skips LaunchServices re-registration and breaks the"
echo "            Screen Recording permission, see issue #4)"
